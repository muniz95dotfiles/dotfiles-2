...
sed -i -e 's/bg = .*/bg = #292929/g' $PDIR/config.ini
# Restarting polybar
$LAUNCH &
...
# Replacing colors
sed -i -e 's/shade1 = .*/shade1 = #F55A47/g' $PDIR/config.ini
sed -i -e 's/shade2 = .*/shade2 = #FF784A/g' $PDIR/config.ini
sed -i -e 's/shade3 = .*/shade3 = #E78A4E/g' $PDIR/config.ini
sed -i -e 's/shade4 = .*/shade4 = #FFAD4A/g' $PDIR/config.ini
sed -i -e 's/shade5 = .*/shade5 = #F5B947/g' $PDIR/config.ini
sed -i -e 's/shade6 = .*/shade6 = #F6BC76/g' $PDIR/config.ini
sed -i -e 's/accent = .*/accent = #F55A47/g' $PDIR/config.ini
